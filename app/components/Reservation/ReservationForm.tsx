...
const ReservationForm = () => {
  return (
    <div className="bg-green-700 p-6 rounded-lg">
      ...
      <h1 className="text-center font-bold uppercase text-[28px] md:text-[30px] lg:text-[40px] mt-[0.5rem] text-white">
        Reservation
      </h1>
      <p className="uppercase text-[16px] md:text-[20px] text-white font-semibold text-center">
        Book your table
      </p>
      ...
      <div className="mt-[2rem]">
        ...
        <input
          type="time"
          className="w-[80%] block mt-[1rem] px-10 py-2.5 bg-transparent rounded-lg mx-auto outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100"
        />
