...
const MobileNav = ({ closeNav, showNav }: Props) => {
  ...
  return (
    ...
    >
      ...
      {/* Nav Div */}
      <div
        className={`bg-emerald-700 ${navStyle} transition-all duration-500 delay-200 flex flex-col items-center justify-center w-[70vw] h-[100%]`}
      >
        {/* Nav Links */}
        <ul className="space-y-10">
          <li className="text-[35px] font-medium hover:text-orange-600 text-white">
            <Link href="/">Home</Link>
          </li>
          <li className="text-[35px] font-medium hover:text-orange-600 text-white">
            <Link href="/">Shop</Link>
